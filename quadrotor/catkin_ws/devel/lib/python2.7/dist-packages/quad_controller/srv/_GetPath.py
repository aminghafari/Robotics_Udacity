...
"""autogenerated by genpy from quad_controller/GetPathRequest.msg. Do not edit."""
import sys
...
class GetPathRequest(genpy.Message):
  _md5sum = "9b6724bbfcc986844015a2e2d7750a81"
  _type = "quad_controller/GetPathRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool ignoreMe
"""
  __slots__ = ['ignoreMe']
  _slot_types = ['bool']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.ignoreMe))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.ignoreMe,) = _get_struct_B().unpack(str[start:end])
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from quad_controller/GetPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPathResponse(genpy.Message):
  ...
  _type = "quad_controller/GetPathResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class GetPath(object):
  _type          = 'quad_controller/GetPath'
  _md5sum = 'f65fd00b2e3f675220a83a94307b7f12'
